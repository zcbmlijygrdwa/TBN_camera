...
/**
 * Created by Zhenyu on 2017-06-17.
 */
...
//        }).start();
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        canvas.drawRect(CameraStreamActivity.boundingBox[0], CameraStreamActivity.boundingBox[1], CameraStreamActivity.boundingBox[2], CameraStreamActivity.boundingBox[3], mPaint);

        mPaint.setTextSize(40);
        mPaint.setStrokeWidth(3.0f);
        mPaint.setColor(Color.BLUE);
        canvas.drawText(Integer.toString(i) + ". data:" + CameraStreamActivity.builder.toString(),200, 200, mPaint);
